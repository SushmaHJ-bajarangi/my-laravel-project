...
use App\Imports\ProductionRequestImport;
use Maatwebsite\Excel\Facades\Excel;
use App\Exports\ProductionRequestExport;
...
class ProductionController extends Controller
{
    public function index()
    {
        ...
        return view('production_request.index')->with('data', $data);
    }
    ...
    public function create()
    {
        ...
        $manufacture = ManufactureStatus::where('is_deleted', 0)->get();
        $manufacture_stages = ManufactureStage::where('is_deleted', 0)->get();
        $manufacture_status = ManufactureStatus::where('is_deleted', 0)->get();
        return view('production_request.create', compact('customer', 'stage_of_material','dispatch_status','priority','manufacture','manufacture_stages','manufacture_status'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(url('production_request'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('production_request.edit', compact('data','customer','stage_of_material','dispatch_status', 'manufacture','manufacture_stages','manufacture_status','priority','p_som', 'p_mns'));
    }
    ...
    public function importproduction(Request $request)
    {
        ...
        Excel::import(new ProductionRequestImport, $request->file('import_file'));
    ...
    {
        $filename ="productionRequest.xlsx";
        return Excel::download(new ProductionRequestExport, $filename);
        Flash::success('exported Successfully');
        return redirect(url('production_request'));
    }

    public function importExportproduction()
    {
        return view('production_request.ImportProductionRequest');
    }
