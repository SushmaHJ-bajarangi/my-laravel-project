...
@section('content')
    ...
    <div class="content">
        @include('adminlte-templates::common.errors')
                    ...
                    <form method="post" action="{{url('job_wise_production/update/'.$data->id)}}">
                        @csrf
                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <input class="form-control" id="place" name="place" type="text" value="{{$data->place}}">
                                    </div>

                                    <div class="form-group col-sm-12">
                                        <label>Job No:</label>
                                        <select class="form-control select2" style="position: relative !important;" name="job_no" id="job_no" onchange="getJobDetails()" required
                                                @if($data->created_from_crm == 1) disabled @endif>
                                            <option selected disabled>Select JobNo</option>
                                            @if(isset($jobno) && count($jobno) > 0)
                                                @foreach($jobno as $item)
                                                    <option value="{{$item->job_no}}" {{$data->job_no == $item->job_no ? 'selected' : ''}}>{{$item->job_no}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-sm-12">
                                        <label for="payment_received_manufacturing_date">Payment Received for Manufacturing Date:</label>
                                        <input class="form-control" id="payment_received_manufacturing_date" name="payment_received_manufacturing_date" type="date"
                                               value="{{$data->payment_received_manufacturing_date}}"
                                               @if($data->created_from_crm == 1) disabled @endif>
                                    </div>
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <input class="form-control" id="crm_confirmation_date" name="crm_confirmation_date" type="date"
                                               value="{{$data->crm_confirmation_date}}"
                                               @if($data->created_from_crm == 1) disabled @endif>
                                    </div>
...
<!--                                        <select class="form-control select2" style="position: relative !important;" name="customer_id" id="customer_id" required-->
<!--                                                @if($data->created_from_crm == 1) disabled @endif>-->
...
<!--                                        </select>-->
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <textarea class="form-control" id="address" name="address" cols="50" rows="10" @if($data->created_from_crm == 1) disabled @endif>{{$data->address}}</textarea>
                                    </div>

                                    <div class="form-group col-sm-12">
                                        <label for="specifications">Specifications:</label>
                                        <textarea class="form-control" id="specifications" name="specifications" cols="50" rows="10" value="{{old('specifications')}}">{{$data->specifications}}</textarea>
                                    </div>
                                    ...
                                    <hr style="clear: both;">
                                                ...
                                                <select class="form-control select2" name="car_bracket" id="car_bracket">
                                                    ...
                                                    @if(isset($carbracket) && count($carbracket) > 0)
                                                        @foreach($carbracket as $item)
                                                            <option value="{{$item->id}}" {{$data->car_bracket == $item->id ? 'selected' : ''}}>{{$item->name}} </option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                                ...
                                                <select class="form-control select2" name="car_bracket_readiness_status" id="car_bracket_readiness_status">
                                                    ...
                                                    @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                        @foreach($readinessstatus as $item)
                                                            <option value="{{$item->id}}" {{$data->car_bracket_readiness_status == $item->id ? 'selected' : ''}}>{{$item->title}} </option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" id="car_bracket_readiness_date" name="car_bracket_readiness_date" type="date" value="{{$data->car_bracket_readiness_date}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                                ...
                                                <select class="form-control select2" name="cwt_bracket" id="cwt_bracket">
                                                    ...
                                                    @if(isset($cwtbracket) && count($cwtbracket) > 0)
                                                        @foreach($cwtbracket as $item)
                                                            <option value="{{$item->id}}" {{$data->cwt_bracket == $item->id ? 'selected' : ''}}>{{$item->name}} </option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="cwt_bracket_readiness_status" id="cwt_bracket_readiness_status">
                                                    ...
                                                    @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                        @foreach($readinessstatus as $item)
                                                            <option value="{{$item->id}}" {{$data->cwt_bracket_readiness_status == $item->id ? 'selected' : ''}}>{{$item->title}} </option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="form-group ">
                                                ...
                                                <input class="form-control" id="cwt_bracket_readiness_date" name="cwt_bracket_readiness_date" type="date" value="{{$data->cwt_bracket_readiness_date}}">
                                            </div>
                                        </div>
                                                ...
                                                <select class="form-control" name="ld_opening" id="ld_opening">
                                                    ...
                                                    @if(isset($ldopening) && count($ldopening) > 0)
                                                        @foreach($ldopening as $item)
                                                            <option value="{{$item->id}}" {{$data->ld_opening == $item->id ? 'selected' : ''}}>{{$item->name}} </option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                                ...
                                                <select class="form-control" name="ld_finish" id="ld_finish">
                                                    ...
                                                    @if(isset($ldfinish) && count($ldfinish) > 0)
                                                        @foreach($ldfinish as $item)
                                                            <option value="{{$item->id}}" {{$data->ld_finish == $item->id ? 'selected' : ''}}>{{$item->name}} </option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="ld_frame_status" id="ld_frame_status">
                                                    ...
                                                    @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                        @foreach($readinessstatus as $item)
                                                            <option value="{{$item->id}}" {{$data->ld_frame_status == $item->id ? 'selected' : ''}}>{{$item->title}} </option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group col-sm-2">
                                            ...
                                            <input class="form-control" id="ld_frame_readiness_date" name="ld_frame_readiness_date" type="date" value="{{$data->ld_frame_readiness_date}}">
                                        </div>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="ld_status" id="ld_status">
                                                    ...
                                                    @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                        @foreach($readinessstatus as $item)
                                                            <option value="{{$item->id}}" {{$data->ld_status == $item->id ? 'selected' : ''}}>{{$item->title}}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group col-sm-2">
                                            ...
                                            <input class="form-control" id="ld_readiness_date" name="ld_readiness_date" type="date" value="{{$data->ld_readiness_date}}">
                                        </div>
                                    </div>

                                    <div class="form-group col-sm-12">
                                        <label for="comments">Comments:</label>
                                        <textarea class="form-control" id="comments" name="comments" cols="50" rows="10" value ="{{old('comments')}}">{{$data->comments}}</textarea>
                                    </div>
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                            ...
                                            <select class="form-control select2" name="machine_channel_type" id="machine_channel_type">
                                                ...
                                                @if(isset($machinechannel) && count($machinechannel) > 0)
                                                    @foreach($machinechannel as $item)
                                                        <option value="{{$item->id}}" {{$data->machine_channel_type == $item->id ? 'selected' : ''}}>{{$item->name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="machine_channel_readiness_status" id="machine_channel_readiness_status">
                                                ...
                                                @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                    @foreach($readinessstatus as $item)
                                                        <option value="{{$item->id}}" {{$data->machine_channel_readiness_status == $item->id ? 'selected' : ''}}>{{$item->title}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <input class="form-control" id="machine_channel_readiness_date" name="machine_channel_readiness_date" type="date" value="{{$data->machine_channel_readiness_date}}">
                                    </div>
                                            ...
                                            <select class="form-control select2" name="machine" id="machine">
                                                ...
                                                @if(isset($machine) && count($machine) > 0)
                                                    @foreach($machine as $item)
                                                        <option value="{{$item->id}}" {{$data->machine == $item->id ? 'selected' : ''}}>{{$item->name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="machine_readiness_status" id="machine_readiness_status">
                                                ...
                                                @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                    @foreach($readinessstatus as $item)
                                                        <option value="{{$item->id}}" {{$data->machine_readiness_status == $item->id ? 'selected' : ''}}>{{$item->title}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <input class="form-control" id="machine_readiness_date" name="machine_readiness_date" type="date" value="{{$data->machine_readiness_date}}">
                                    </div>
                                            ...
                                            <select class="form-control select2" name="car_frame" id="car_frame">
                                                ...
                                                @if(isset($carframe) && count($carframe) > 0)
                                                    @foreach($carframe as $item)
                                                        <option value="{{$item->id}}"  {{$data->car_frame == $item->id ? 'selected' : ''}}>{{$item->name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="car_frame_readiness_status" id="car_frame_readiness_status">
                                                ...
                                                @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                    @foreach($readinessstatus as $item)
                                                        <option value="{{$item->id}}" {{$data->car_frame_readiness_status == $item->id ? 'selected' : ''}}>{{$item->title}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <input class="form-control" id="car_frame_readiness_date" name="car_frame_readiness_date" type="date" value="{{$data->car_frame_readiness_date}}">
                                    </div>
                                            ...
                                            <select class="form-control select2" name="cwt_frame" id="cwt_frame">
                                                ...
                                                @if(isset($cwtframe) && count($cwtframe) > 0)
                                                    @foreach($cwtframe as $item)
                                                        <option value="{{$item->id}}" {{$data->cwt_frame == $item->id ? 'selected' : ''}}>{{$item->name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label>Cwt Frame Status</label>
                                            <select class="form-control select2" name="cwt_frame_readiness_status" id="cwt_frame_status">
                                                <option selected disabled>Select Car Bracket</option>
                                                @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                    @foreach($readinessstatus as $item)
                                                        <option value="{{$item->id}}" {{$data->cwt_frame_readiness_status == $item->id ? 'selected' : ''}}>{{$item->title}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group col-sm-4">
                                        <label for="cwt_frame_readiness_date">Car Frame Radiness Date:</label>
                                        <input class="form-control" id="cwt_frame_readiness_date" name="cwt_frame_readiness_date" type="date" value="{{$data->cwt_frame_readiness_date}}">
                                    </div>
                                            ...
                                            <select class="form-control select2" name="rope_available" id="rope_available">
                                                ...
                                                @if(isset($ropeavailable) && count($ropeavailable) > 0)
                                                    @foreach($ropeavailable as $item)
                                                        <option value="{{$item->id}}" {{$data->rope_available == $item->id ? 'selected' : ''}}>{{$item->name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                            ...
                                            <select class="form-control select2" name="osg_assy_available" id="osg_assy_available">
                                                ...
                                                @if(isset($osgassyavailable) && count($osgassyavailable) > 0)
                                                    @foreach($osgassyavailable as $item)
                                                        <option value="{{$item->id}}" {{$data->osg_assy_available == $item->id ? 'selected' : ''}}>{{$item->name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <textarea class="form-control" id="comment_after_osg" name="comment_after_osg" cols="50" rows="10">{{$data->comment_after_osg}}</textarea>
                                    </div>
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="cabin" id="cabin">
                                                ...
                                                @if(isset($ldfinish) && count($ldfinish) > 0)
                                                    @foreach($ldfinish as $item)
                                                        <option value="{{$item->id}}" {{$data->cabin == $item->id ? 'selected' : ''}}>{{$item->name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="cabin_readiness_status" id="cabin_readiness_status">
                                                ...
                                                @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                    @foreach($readinessstatus as $item)
                                                        <option value="{{$item->id}}" {{$data->cabin_readiness_status == $item->id ? 'selected' : ''}}>{{$item->title}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <input class="form-control" id="cabin_readiness_date" name="cabin_readiness_date" type="date" value="{{$data->cabin_readiness_date}}">
                                    </div>
                                            ...
                                            <select class="form-control select2" name="controller" id="controller">
                                                ...
                                                @if(isset($controller) && count($controller) > 0)
                                                    @foreach($controller as $item)
                                                        <option value="{{$item->id}}" {{$data->controller == $item->id ? 'selected' : ''}}>{{$item->name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="controller_readiness_status" id="controller_readiness_status">
                                                ...
                                                @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                    @foreach($readinessstatus as $item)
                                                        <option value="{{$item->id}}" {{$data->controller_readiness_status == $item->id ? 'selected' : ''}}>{{$item->title}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <input class="form-control" id="controller_readiness_date" name="controller_readiness_date" type="date" value="{{$data->controller_readiness_date}}">
                                    </div>
                                            ...
                                            <select class="form-control select2" name="car_door_opening" id="car_door_opening">
                                                ...
                                                @if(isset($cardooropening) && count($cardooropening) > 0)
                                                    @foreach($cardooropening as $item)
                                                        <option value="{{$item->id}}" {{$data->car_door_opening == $item->id ? 'selected' : ''}}>{{$item->name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="car_door_finish" id="car_door_finish">
                                                ...
                                                @if(isset($ldfinish) && count($ldfinish) > 0)
                                                    @foreach($ldfinish as $item)
                                                        <option value="{{$item->id}}" {{$data->car_door_finish == $item->id ? 'selected' : ''}}>{{$item->name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="car_door_status" id="car_door_status">
                                                <option selected disabled>Select car door status</option>
                                                @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                    @foreach($readinessstatus as $item)
                                                        <option value="{{$item->id}}" {{$data->car_door_readiness_status == $item->id ? 'selected' : ''}}>{{$item->title}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group col-sm-3">
                                        ...
                                        <input class="form-control" id="car_door_readiness_date" name="car_door_readiness_date" type="date" value="{{$data->car_door_readiness_date}}">
                                    </div>
                                            ...
                                            <select class="form-control select2" name="cop_lop" id="cop_and_lop">
                                                ...
                                                @if(isset($copandlop) && count($copandlop) > 0)
                                                    @foreach($copandlop as $item)
                                                        <option value="{{$item->id}}" {{$data->cop_lop == $item->id ? 'selected' : ''}}>{{$item->name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="cop_lop_readiness_status" id="cop_and_lop_status">
                                                ...
                                                @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                    @foreach($readinessstatus as $item)
                                                        <option value="{{$item->id}}" {{$data->cop_lop_readiness_status == $item->id ? 'selected' : ''}}>{{$item->title}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <input class="form-control" id="cop_and_lop_readiness_date" name="cop_lop_readiness_date" type="date" value="{{$data->cop_lop_readiness_date}}">
                                    </div>
                                            ...
                                            <select class="form-control select2" name="harness" id="harness">
                                                ...
                                                @if(isset($harness) && count($harness) > 0)
                                                    @foreach($harness as $item)
                                                        <option value="{{$item->id}}" {{$data->harness == $item->id ? 'selected' : ''}}>{{$item->name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="harness_readiness_status" id="harness_readiness_status">
                                                ...
                                                @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                    @foreach($readinessstatus as $item)
                                                        <option value="{{$item->id}}" {{$data->harness_readiness_status == $item->id ? 'selected' : ''}}>{{$item->title}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <input class="form-control" id="harness_readiness_date" name="harness_readiness_date" type="date" value="{{$data->harness_readiness_date}}">
                                    </div>

                                    <div class="form-group col-sm-12">
                                        <label for="commentscommentscomments">Comments:</label>
                                        <textarea class="form-control" id="commentscommentscomments" name="commentscommentscomments" cols="50" rows="10">{{$data->commentscommentscomments}}</textarea>
                                    </div>
                            ...
                            <div class="box-body">
                                ...
                                <hr style="clear: both;">
                                    ...
                                    <div class="form-group col-sm-12 ckeck1">
                                        ...
                                        <input type="checkbox" id="myCheck" onclick="toggleFields()" name="is_revised" @if($data->is_revised == 1) checked @endif>
                                    </div>

                                    <div class="form-group fullDispatch1 col-sm-3" @if($data->is_revised != 1) style="display:none" @endif>
                                        <label for="full_dispatched_date1">Full Dispatched Date:</label>
                                        <input class="form-control" id="full_dispatched_date1" name="full_dispatched_date1" type="date" value="{{$data->full_dispatched_date1}}">
                                    </div>

                                    <div id="otherFields1">
                                        <div class="row">
                                            <div class="col-lg-3 col-md-3 col-sm-5 col-12">
                                                <div class="form-group"  @if($data->is_revised == 1) style="display:none" @endif>
                                                    <label>Car Bracket Available Status</label>
                                                    <select class="form-control select2" name="car_bracket_available_status" id="car_bracket_available_status">
                                                        <option selected disabled>Select Car Bracket Available Status</option>
                                                        @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                            @foreach($readinessstatus as $item)
                                                                <option value="{{$item->id}}" {{$data->car_bracket_available_status == $item->id ? 'selected' : ''}}>{{$item->title}}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-5 col-12">
                                                <div class="form-group" @if($data->is_revised == 1) style="display:none" @endif>
                                                    ...
                                                    <input class="form-control" id="car_bracket_available_date" name="car_bracket_available_date" type="date" value="{{$data->car_bracket_available_date}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-5 col-12">
                                                <div class="form-group" @if($data->is_revised == 1) style="display:none" @endif>
                                                    ...
                                                    <select class="form-control select2" name="car_bracket_dispatch_status" id="car_bracket_dispatch_status">
                                                        ...
                                                        @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                            @foreach($readinessstatus as $item)
                                                                <option value="{{$item->id}}" {{$data->car_bracket_dispatch_status == $item->id ? 'selected' : ''}}>{{$item->title}}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-5 col-12">
                                                <div class="form-group" @if($data->is_revised == 1) style="display:none" @endif>
                                                    ...
                                                    <input class="form-control" id="car_bracket_dispatch_date" name="car_bracket_dispatch_date" type="date" value="{{$data->car_bracket_dispatch_date}}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-md-3 col-sm-5 col-12">
                                                <div class="form-group" @if($data->is_revised == 1) style="display:none" @endif>
                                                    ...
                                                    <select class="form-control select2" name="cwt_bracket_available_status" id="cwt_bracket_available_status">
                                                        ...
                                                        @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                            @foreach($readinessstatus as $item)
                                                                <option value="{{$item->id}}" {{$data->cwt_bracket_available_status == $item->id ? 'selected' : ''}}>{{$item->title}}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-5 col-12">
                                                <div class="form-group" @if($data->is_revised == 1) style="display:none" @endif>
                                                    ...
                                                    <input class="form-control" id="cwt_bracket_available_date" name="cwt_bracket_available_date" type="date" value="{{$data->cwt_bracket_available_date}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-5 col-12">
                                                <div class="form-group" @if($data->is_revised == 1) style="display:none" @endif>
                                                    ...
                                                    <select class="form-control select2" name="cwt_bracket_dispatch_status" id="cwt_bracket_dispatch_status">
                                                        ...
                                                        @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                            @foreach($readinessstatus as $item)
                                                                <option value="{{$item->id}}" {{$data->cwt_bracket_dispatch_status == $item->id ? 'selected' : ''}}>{{$item->title}}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-5 col-12">
                                                <div class="form-group" @if($data->is_revised == 1) style="display:none" @endif>
                                                    ...
                                                    <input class="form-control" id="cwt_bracket_dispatch_date" name="cwt_bracket_dispatch_date" type="date" value="{{$data->cwt_bracket_dispatch_date}}">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                                <div class="form-group" @if($data->is_revised == 1) style="display:none" @endif>
                                                    ...
                                                    <input class="form-control" id="ld_frame_received_date" name="ld_frame_received_date" type="date" value="{{$data->ld_frame_received_date}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                                <div class="form-group" @if($data->is_revised == 1) style="display:none" @endif>
                                                    ...
                                                    <select class="form-control select2" name="ld_frame_dispatch_status" id="ld_frame_dispatch_status">
                                                        ...
                                                        @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                            @foreach($readinessstatus as $item)
                                                                <option value="{{$item->id}}" {{$data->ld_frame_dispatch_status == $item->id ? 'selected' : ''}}>{{$item->title}}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                                <div class="form-group" @if($data->is_revised == 1) style="display:none" @endif>
                                                    ...
                                                    <input class="form-control" id="ld_frame_dispatch_date" name="ld_frame_dispatch_date" type="date" value="{{$data->ld_frame_dispatch_date}}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                                <div class="form-group" @if($data->is_revised == 1) style="display:none" @endif>
                                                    ...
                                                    <input class="form-control" id="ld_received_date" name="ld_received_date" type="date" value="{{$data->ld_received_date}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                                <div class="form-group" @if($data->is_revised == 1) style="display:none" @endif>
                                                    ...
                                                    <select class="form-control select2" name="ld_dispatch_status" id="ld_dispatch_status">
                                                        ...
                                                        @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                            @foreach($readinessstatus as $item)
                                                                <option value="{{$item->id}}" {{$data->ld_dispatch_status == $item->id ? 'selected' : ''}}>{{$item->title}}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                                <div class="form-group" @if($data->is_revised == 1) style="display:none" @endif>
                                                    ...
                                                    <input class="form-control" id="ld_dispatch_date" name="ld_dispatch_date" type="date" value = "{{$data->ld_dispatch_date}}">
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="box box-solid">
                            <div class="box-body">
                                ...
                                <hr style="clear: both;">
                                    ...
                                    <div class="form-group col-sm-12">
                                        <label for="is_checkedbox">Is checked:</label>
                                        <input type="checkbox" id="is_checkedbox" onclick="toggleFields_two()" name="is_revised_check" @if($data->is_checkedbox == 1) checked @endif>
                                    </div>

                                    <div class="form-group fullDispatch1 col-sm-3" @if($data->is_checkedbox != 1)  style="display:none" @endif>
                                        <label for="full_dispatched_date2">Full Dispatched Date:</label>
                                        <input class="form-control" id="full_dispatched_date2" name="full_dispatched_date2" type="date" value="{{$data->full_dispatched_date2}}">
                                    </div>

                                    <div id="otherFields2" >
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                                <div class="form-group" @if($data->is_checkedbox == 1) style="display:none" @endif>
                                                    <label for="machine_channel_received_date">Machine Channel Received Date:</label>
                                                    <input class="form-control" id="machine_channel_received_date" name="machine_channel_received_date" type="date" value="{{$data->machine_channel_received_date}}">
                                                </div>
                                            </div>

                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                                <div class="form-group d-flex flex-column" @if($data->is_checkedbox == 1) style="display:none" @endif>
                                                    ...
                                                    <select class="form-control select2" name="machine_channel_dispatch_status" id="machine_channel_dispatch_status">
                                                        ...
                                                        @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                            @foreach($readinessstatus as $item)
                                                                <option value="{{$item->id}}" {{$data->machine_channel_dispatch_status == $item->id ? 'selected' : ''}}>{{$item->title}}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                                <div class="form-group dispatch_date1"  @if($data->is_checkedbox == 1) style="display:none" @endif>
                                                    <label for="machine_channel_dispatch_date">Machine Channel Dispatch Date:</label>
                                                    <input class="form-control" id="machine_channel_dispatch_date" name="machine_channel_dispatch_date" type="date" value="{{$data->machine_channel_dispatch_date}}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                                <div class="form-group dispatch_date1"  @if($data->is_checkedbox == 1) style="display:none" @endif>
                                                    ...
                                                    <input class="form-control" id="machine_available_date" name="machine_available_date" type="date" value="{{$data->machine_available_date}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                                <div class="form-group d-flex flex-column"  @if($data->is_checkedbox == 1) style="display:none" @endif>
                                                    ...
                                                    <select class="form-control select2" name="machine_dispatch_status" id="machine_dispatch_status">
                                                        ...
                                                        @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                            @foreach($readinessstatus as $item)
                                                                <option value="{{$item->id}}" {{$data->machine_dispatch_status == $item->id ? 'selected' : ''}}>{{$item->title}}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12"  @if($data->is_checkedbox == 1) style="display:none" @endif>
                                                <div class="form-group dispatch_date1">
                                                    <label for="machine_dispatch_date">Machine Dispatch Date:</label>
                                                    <input class="form-control" id="machine_dispatch_date" name="machine_dispatch_date" type="date" value="{{$data->machine_dispatch_date}}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12"  @if($data->is_checkedbox == 1) style="display:none" @endif>
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="car_frame_received_date" name="car_frame_received_date" type="date" value="{{$data->car_frame_received_date}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12"  @if($data->is_checkedbox == 1) style="display:none" @endif>
                                                <div class="form-group d-flex flex-column">
                                                    ...
                                                    <select class="form-control select2" name="car_frame_dispatch_status" id="car_frame_dispatch_status">
                                                        ...
                                                        @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                            @foreach($readinessstatus as $item)
                                                                <option value="{{$item->id}}" {{$data->car_frame_dispatch_status == $item->id ? 'selected' : ''}}>{{$item->title}}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12"  @if($data->is_checkedbox == 1) style="display:none" @endif>
                                                <div class="form-group dispatch_date2 ">
                                                    ...
                                                    <input class="form-control" id="car_frame_dispatch_date" name="car_frame_dispatch_date" type="date" value="{{$data->car_frame_dispatch_date}}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12"  @if($data->is_checkedbox == 1) style="display:none" @endif>
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="cwt_frame_received_date" name="cwt_frame_received_date" type="date" value="{{$data->cwt_frame_received_date}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12"  @if($data->is_checkedbox == 1) style="display:none" @endif>
                                                <div class="form-group d-flex flex-column">
                                                    ...
                                                    <select class="form-control select2" name="cwt_frame_dispatch_status" id="cwt_frame_dispatch_status">
                                                        ...
                                                        @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                            @foreach($readinessstatus as $item)
                                                                <option value="{{$item->id}}" {{$data->cwt_frame_dispatch_status == $item->id ? 'selected' : ''}}>{{$item->title}}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12"  @if($data->is_checkedbox == 1) style="display:none" @endif>
                                                <div class="form-group dispatch_date2">
                                                    ...
                                                    <input class="form-control" id="cwt_frame_dispatch_date" name="cwt_frame_dispatch_date" type="date" value="{{$data->cwt_frame_dispatch_date}}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12"  @if($data->is_checkedbox == 1) style="display:none" @endif>
                                                <div class="form-group dispatch_date1">
                                                    ...
                                                    <input class="form-control" id="rope_available_date" name="rope_available_date" type="date" value="{{$data->rope_available_date}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12"  @if($data->is_checkedbox == 1) style="display:none" @endif>
                                                <div class="form-group d-flex flex-column">
                                                    ...
                                                    <select class="form-control select2" name="rope_dispatch_status" id="rope_dispatch_status">
                                                        ...
                                                        @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                            @foreach($readinessstatus as $item)
                                                                <option value="{{$item->id}}" {{$data->rope_dispatch_status == $item->id ? 'selected' : ''}}>{{$item->title}}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12"  @if($data->is_checkedbox == 1) style="display:none" @endif>
                                                <div class="form-group dispatch_date1">
                                                    ...
                                                    <input class="form-control" id="rope_dispatch_date" name="rope_dispatch_date" type="date" value="{{$data->rope_dispatch_date}}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12" >
                                                <div class="form-group dispatch_date1"  @if($data->is_checkedbox == 1) style="display:none" @endif>
                                                    ...
                                                    <input class="form-control" id="osg_assy_available_date" name="osg_assy_available_date" type="date" value="{{$data->osg_assy_available_date}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                                <div class="form-group d-flex flex-column"  @if($data->is_checkedbox == 1) style="display:none" @endif>
                                                    ...
                                                    <select class="form-control select2" name="osg_assy_dispatch_status" id="osg_assy_dispatch_status">
                                                        ...
                                                        @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                            @foreach($readinessstatus as $item)
                                                                <option value="{{$item->id}}" {{$data->osg_assy_dispatch_status == $item->id ? 'selected' : ''}}>{{$item->title}}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                                <div class="form-group dispatch_date1"  @if($data->is_checkedbox == 1) style="display:none" @endif>
                                                    ...
                                                    <input class="form-control" id="osg_assy_dispatch_date" name="osg_assy_dispatch_date" type="date" value="{{$data->osg_assy_dispatch_date}}">
                                                </div>
                                            </div>
                        ...
                        <div class="box box-solid">
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-12 ckeck1">
                                        <label for="myCheckbox">Is checkBox:</label>
                                        <input type="checkbox" id="myCheckbox" onclick="toggleFields_three()" name="is_check" @if($data->is_check == 1) checked @endif>
                                    </div>

                                    <div class="form-group fullDispatch3 col-sm-3" @if($data->is_check != 1) style="display:none" @endif>
                                        <label for="full_dispatched_date3">Full Dispatched Date:</label>
                                        <input class="form-control" id="full_dispatched_date3" name="full_dispatched_date3" type="date" value="{{$data->full_dispatched_date3}}">
                                    </div>
                                </div>
                                ...
                                <div id="otherFields3">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="form-group" @if($data->is_check ==1) style ='display:none' @endif>
                                                <label for="cabin_received_date">Cabin Received Date:</label>
                                                <input class="form-control" id="cabin_received_date" name="cabin_received_date" type="date" value="{{$data->cabin_received_date}}">
                                            </div>
                                        </div>

                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="form-group d-flex flex-column" @if($data->is_check ==1) style ='display:none' @endif>
                                                ...
                                                <select class="form-control w-100 select2" name="cabin_dispatch_status" id="cabin_dispatch_status">
                                                    ...
                                                    @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                        @foreach($readinessstatus as $item)
                                                            <option value="{{$item->id}}" {{$data->cabin_dispatch_status == $item->id ? 'selected' : ''}}>{{$item->title}}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="form-group dispatch_date1" @if($data->is_check ==1) style ='display:none' @endif>
                                                <label for="cabin_dispatch_date">Cabin Dispatch Date:</label>
                                                <input class="form-control" id="cabin_dispatch_date" name="cabin_dispatch_date" type="date" value="{{$data->cabin_dispatch_date}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="form-group dispatch_date1" @if($data->is_check ==1) style ='display:none' @endif>
                                                ...
                                                <input class="form-control" id="controller_available_date" name="controller_available_date" type="date" value="{{$data->controller_available_date}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="form-group d-flex flex-column" @if($data->is_check ==1) style ='display:none' @endif>
                                                ...
                                                <select class="form-control select2" name="controller_dispatch_status" id="controller_dispatch_status">
                                                    ...
                                                    @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                        @foreach($readinessstatus as $item)
                                                            <option value="{{$item->id}}" {{$data->controller_dispatch_status == $item->id ? 'selected' : ''}} >{{$item->title}}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="form-group dispatch_date1" @if($data->is_check ==1) style ='display:none' @endif>
                                                ...
                                                <input class="form-control" id="controller_dispatch_date" name="controller_dispatch_date" type="date" value="{{$data->controller_dispatch_date }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="form-group" @if($data->is_check ==1) style ='display:none' @endif>
                                                ...
                                                <input class="form-control" id="car_door_received_date" name="car_door_received_date" type="date" value="{{$data->car_door_received_date}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="form-group d-flex flex-column" @if($data->is_check ==1) style ='display:none' @endif>
                                                ...
                                                <select class="form-control select2" name="car_door_dispatch_status" id="car_door_dispatch_status">
                                                    ...
                                                    @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                        @foreach($readinessstatus as $item)
                                                            <option value="{{$item->id}}" {{$data->car_door_dispatch_status == $item->id ? 'selected' : ''}} >{{$item->title}}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="form-group dispatch_date2" @if($data->is_check ==1) style ='display:none' @endif>
                                                <label for="car_door__dispatch_date">Car Door Dispatch Date:</label>
                                                <input class="form-control" id="car_door__dispatch_date" name="car_door__dispatch_date" type="date" value="{{$data->car_door__dispatch_date}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="form-group" @if($data->is_check ==1) style ='display:none' @endif>
                                                ...
                                                <input class="form-control" id="cop_lop_received_date" name="cop_lop_received_date" type="date" value="{{$data->cop_lop_received_date}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="form-group d-flex flex-column" @if($data->is_check ==1) style ='display:none' @endif>
                                                ...
                                                <select class="form-control select2" name="cop_lop_dispatch_status" id="cop_lop_dispatch_status">
                                                    ...
                                                    @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                        @foreach($readinessstatus as $item)
                                                            <option value="{{$item->id}}" {{$data->cop_lop_dispatch_status == $item->id ? 'selected' : ''}}>{{$item->title}}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="form-group dispatch_date2" @if($data->is_check ==1) style ='display:none' @endif>
                                                ...
                                                <input class="form-control" id="cop_lop__dispatch_date" name="cop_lop__dispatch_date" type="date" value="{{$data->cop_lop__dispatch_date}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="form-group dispatch_date1" @if($data->is_check ==1) style ='display:none' @endif>
                                                ...
                                                <input class="form-control" id="harness_available_date" name="harness_available_date" type="date" value="{{$data->harness_available_date}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="form-group d-flex flex-column" @if($data->is_check ==1) style ='display:none' @endif>
                                                ...
                                                <select class="form-control select2" name="harness_dispatch_status" id="harness_dispatch_status">
                                                    ...
                                                    @if(isset($readinessstatus) && count($readinessstatus) > 0)
                                                        @foreach($readinessstatus as $item)
                                                            <option value="{{$item->id}}"  {{$data->harness_dispatch_status == $item->id ? 'selected' : ''}}>{{$item->title}}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <div class="form-group dispatch_date1" @if($data->is_check ==1) style ='display:none' @endif>
                                                ...
                                                <input class="form-control" id="harness_dispatch_date" name="harness_dispatch_date" type="date" value="{{$data->harness_dispatch_date}}">
                                            </div>
                                        </div>
                                    </div>
...
@section('scripts')
    ...
    <script>
        function toggleFields_two() {
            ...
            var otherFields2 = document.getElementById('otherFields2');

            if (isChecked2) {
                fullDispatchDate2.style.display = 'block';
                otherFields2.style.display = 'none';
            } else {
                fullDispatchDate2.style.display = 'none';
                otherFields2.style.display = 'block';
            }
        }
    ...
    <script>
        function toggleFields_three() {
            ...
            var otherFields = document.getElementById('otherFields3');
