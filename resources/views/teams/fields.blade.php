...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('contact_number', null, ['class' => 'form-control contact_number','id'=>'contact_number','maxlength'=>'10']) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    <select class="form-control" name="zone" id="zone">
        ...
        <option @if(isset($team) && $team->zone == $customer_zone->id) selected @endif  value="{{$customer_zone->id}}">{{$customer_zone->title}}</option>
        @endforeach
        @endif
    </select>
</div>
    ...
    @foreach($helpers as $helper)
        <div class="remove_{{$helper->id}}">
            ...
            <div class="form-group col-sm-5">
                ...
                <input class="form-control contact_number" name="helper_contact_number[]" type="text" value="{{$helper->contact_number}}" id="contact_number" maxlength="10">
            </div>
...
<div class="form-group col-sm-5">
    <label>Contact Number</label>
    <input class="form-control contact_number" name="helper_contact_number[]" type="text" id="contact_number" maxlength="10">
</div>
<div class="form-group col-sm-2">
