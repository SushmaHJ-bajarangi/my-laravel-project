        ...
        @foreach($data as $item)
            ...
            <tr>
                ...
                <td class="text-center">
                    <div class='btn-group'>
                        {!! Form::open(['url' => ['manufacture_production/delete', $item->id], 'method' => 'post']) !!}
                        <a href="{{ url('manufacture_production/edit', [$item->id]) }}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
